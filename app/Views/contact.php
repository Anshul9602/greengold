...
<!-- Contact Us Section Start -->
                    ...
                    <ul class="contact-info">
                        ...
                        <li>
                            ...
                            <div class="contact-info-content">
                                ...
                                <span class="text"><a href="mailto:hello@avers.com">sales@greengold.com</a></span>
                            </div>
                        </li>
                    </ul>
    ...
    <!-- <div class="section-margin-bottom">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="contact-map-section wow fadeIn" fadeIndata-wow-duration=".1s" data-wow-delay=".1s">
                        
                        <div class="google-map-area w-100">
                            <div class="icon">
                                <img src="/images/contact/map-icon.png" alt="Map-Icon">
                            </div>
