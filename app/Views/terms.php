...
<div class="row">
    ...
    <h1 class="title">Terms & Conditions
                        </h1>
    </div>                   
    ...
    <p><strong>General Information:</strong> The content on our website is provided for general information and use only. We reserve the right to change this content without notice.</p>
    <p><strong>Cookies:</strong> We use cookies to monitor browsing preferences. If you permit cookies, no personal information will be stored by us.</p>
    <p><strong>Warranties:</strong> We do not provide any warranties regarding the accuracy, timeliness, performance, completeness, or suitability of the information and materials on our website. Any reliance you place on such information is strictly at your own risk.</p>
    ...
    <h4>4. Liability</h4>
    <p><strong>Limitation of Liability:</strong> Your use of any information or materials on this website is entirely at your own risk. We shall not be liable for any damages arising from such use, to the fullest extent permitted by law.</p>

    <h4>5. External Links</h4>
    <p><strong>Third-Party Links:</strong> Our website may include links to other websites for your convenience. We do not endorse these external sites and are not responsible for their content or privacy practices.</p>
