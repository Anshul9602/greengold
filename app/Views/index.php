               ...
               <div class="accordion about-accordion" id="faqone">
                  ...
                  <div class="accordion-item faq-accordion-item">
                     ...
                     <div id="collapseTwo" class="accordion-collapse collapse faq-accordion-collapse" aria-labelledby="headingTwo" data-bs-parent="#faqone">
                        <p class="accordion-body">
                           Our market making practices ensure adequate supply along with trade finance to our customers – leading to a direct, deep & strengthened relationship with marque clients including leading steel producers in India, Bangladesh Pakistan, Taiwan et al
                     </div>
                  </div>
                  <div class="accordion-item faq-accordion-item">
                            ...
                            <div class="testimonialone">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <!--== Start Testimonial Item ==-->
                                        <div class="testimonialone-single">
                                            <p class="testimonialone-text">Our partnership with green gold has been consistently reinforced with transparent, timely & professional handling of their committements.</p>
                                            <div class="testimonialone-content">
