            ...
            <div class="row">
                <div class="col-lg-6 wow fadeIn" fadeIndata-wow-duration=".1s" data-wow-delay=".1s">
                    ...
                    <div class="about-two-images me-0">
                        <div class="about-two-images-one">
                            <img class="js-tilt" src="<?php echo base_url(''); ?>/images/about/about-4.png" alt="QualityImage">
                ...
                <div class="col-lg-6 wow fadeIn" fadeIndata-wow-duration=".01s" data-wow-delay=".1s">
                    ...
                    <div class="heading-one">
                        <span class="heading-one-subtitle">Mission</span>
                        <h2 class="heading-one-title">Creating Opportunities, Sharing Success</h2>

                        <div class="about-two-text">
                            <p>Our mission at Jaguar Steel and Coal Pte Ltd. (JSC) is to foster growth and success by creating opportunities for our partners and stakeholders. We believe in the principle, "Until you learn to share, you can never grow. To Grow, You have to Grow Together." This core value drives us to execute every deal with full transparency, ensuring trust and mutual benefit for both our suppliers and customers. 
                            </p>
                            <p>We strive to maintain high standards of service, business conduct, and product quality, valuing long-term, sustainable relationships based on integrity, cooperation, and mutual benefit.</p>
            ...
            <div class="row">
                <div class="col-lg-6 wow fadeIn" fadeIndata-wow-duration=".1s" data-wow-delay=".1s">
                    ...
                    <div class="about-creative-images">
                        <div class="image-one">
                            <img src="<?php echo base_url(''); ?>/images/about/creative-one.png" alt="AboutImage">
                        </div>
                        <div class="image-two">
                            <img src="<?php echo base_url(''); ?>/images/about/creative-two.png" alt="AboutImage">
                        </div>
                    </div>
                ...
                <div class="col-lg-6 wow fadeIn" fadeIndata-wow-duration=".01s" data-wow-delay=".1s">
                    <div class="about-creative-details">
                        ...
                        <div class="heading-one">
                            <span class="heading-one-subtitle">Vission</span>
                            <h2 class="heading-one-title">Leading with Integrity and Innovation </h2>
                            <p>Our vision is to be a global leader in the Metals and Steel Industry, recognized for our integrity, innovation, and commitment to building strong, all-weather relationships. We aim to guide and protect our clients from market volatility, ensuring their long-term success and loyalty. By continuously enhancing our processes and embracing new opportunities, we aspire to set new benchmarks in quality, reliability, and economic efficiency, creating value for our partners and driving sustained growth for our organization.</p>
                        </div>
