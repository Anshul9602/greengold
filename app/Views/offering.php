 ...
 <div class="section-padding breadcrumb" data-bg-image="/images/header.png">
            ...
            <div class="row">
                <div class="col-12 align-items-center text-center">
                    ...
                    <div class="breadcrumb-wrapper">
                        <h1 class="title">Our Offerings</h1>
    ...
    <div class="card-content">
        <img src="/images/offering/offering1.png">
...
<div class="cardd">
    <div class="card-content">
        <img src="/images/offering/offering2.png">
...
<div class="cardd">
    <div class="card-content">
        <img src="/images/offering/offering3.png">
        <h4 class="color">Operations & Maintenance</h4>
      <p class="card-description-w">In connection with contracts that may vary from a few months to many years, we operate and maintain water and wastewater treatment plants, whether or not we built them, to enable customers to optimize their production costs associated with water and wastewater treatment, to ensure effective management.</p>
      <div>
      <a href="operations" class="btn-style-two less"><span>Learn more</span></a>
      </div>
    </div>
</div> 
